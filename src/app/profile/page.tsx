      ...
      <div className="mx-auto w-full max-w-md md:max-w-7xl min-h-screen flex flex-col relative border-x border-neutral-800/60">
        ...
        <main className="w-full max-w-4xl mx-auto px-4 pt-5 pb-32 space-y-5">
          ...
          <section className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-wider text-neutral-500">Account</p>
            <div className="bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-3 space-y-2">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-[10px] text-neutral-600 font-mono truncate max-w-[180px]">{user.id}</span>
              </div>
              {isAdmin && (
                <>
                  <div className="border-t border-neutral-800" />
          ...
          {isAdmin && (
            <section className="space-y-3">
              <p className="text-xs font-semibold uppercase tracking-wider text-neutral-500">Administration</p>
              <Link
                href="/admin"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-amber-300">Open Admin Panel</span>
                </div>
                <span className="text-xs text-amber-700 group-hover:text-amber-500 transition-colors">Moderate peer stories →</span>
              </Link>
            </section>
          )}
          ...
          {/* ── Display name ── */}
          <section className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-wider text-neutral-500">Display name</p>
          ...
          {/* ── Change password ── */}
          <section className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-wider text-neutral-500">Password</p>
            <div className="bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-4">
              <ChangePasswordForm />
            </div>
          </section>
          ...
          {/* ── Danger zone ── */}
          <section className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-wider text-red-900">Danger zone</p>
            <DeleteAccountForm />
          </section>
