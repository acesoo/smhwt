...
### 3.2 The App as a "Ba"
The application functions as a **"Cyber Ba"**—a virtual knowledge space. It provides the "secure single place" required for the student to interact with their own data. In this "Ba," the student moves from:
...
* **Structured Mood Journal (Externalization):** Prevents information loss by documenting internal states immediately.
